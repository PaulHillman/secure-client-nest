...
import { LayoutDashboard, Users, FolderLock, LogOut, FolderOpen, ClipboardList, ListTodo, CalendarCheck } from "lucide-react";
...
function AppLayout() {
  ...
  const nav = [
    ...
    { to: "/app/meetings", label: "Weekly Meetings", icon: CalendarCheck },
